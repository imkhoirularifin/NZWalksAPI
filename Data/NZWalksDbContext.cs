...
namespace NZWalksAPI.Data
{
    public class NZWalksDbContext(DbContextOptions opt) : DbContext(opt)
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                new() { Id = Guid.Parse("43145d1f-6238-4ecf-bf81-83d4d79abaa8"), Name = "Easy", },
                new() { Id = Guid.Parse("adb1ad87-6f48-4242-b1a6-68fe0913bf17"), Name = "Medium", },
                new() { Id = Guid.Parse("0d16a9ee-296b-413b-812e-99a3a381c972"), Name = "Hard", },
            };

            // Seed difficulties into db
