    ...
    public partial class seedingdifficultiesandregions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("0d16a9ee-296b-413b-812e-99a3a381c972"), "Hard" },
                    { new Guid("43145d1f-6238-4ecf-bf81-83d4d79abaa8"), "Easy" },
                    { new Guid("adb1ad87-6f48-4242-b1a6-68fe0913bf17"), "Medium" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("0d16a9ee-296b-413b-812e-99a3a381c972"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("43145d1f-6238-4ecf-bf81-83d4d79abaa8"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("adb1ad87-6f48-4242-b1a6-68fe0913bf17"));
